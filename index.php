...
<link type="text/css" rel="stylesheet" href="./plugins/navcar/css/nav.css"/>
<link type="text/css" rel="stylesheet" href="./plugins/layer/skin/default/layer.css"/>
</head>
<body>
<div class="container">
   <h1>PHP Session购物车</h1>
       	...
       	<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			      ...
			      <div class="col-sm-6 col-md-4">
				    <div class="thumbnail">			      
				      <img src="./resources/images/product-01.jpg" alt="产品">
				      <div class="caption">
				        <h3>产品1</h3>
				  ...
				  <div class="col-sm-6 col-md-4">
				    <div class="thumbnail">
				      <img src="./resources/images/product-02.jpg" alt="产品">
				      <div class="caption">
				        <h3>产品1</h3>
				        <p>这个产品很不错，我很喜欢这个产品。真是太好了.....</p>
				        <p><a href="javascript:voud(0);" class="btn btn-primary" role="button">加入购物车</a></p>
				  ...
				  <div class="col-sm-6 col-md-4">
				    <div class="thumbnail">
				      <img src="./resources/images/product-03.jpg" alt="产品">
				      <div class="caption">
				        <h3>产品1</h3>
				        <p>这个产品很不错，我很喜欢这个产品。真是太好了.....</p>
				        <p><a href="javascript:voud(0);" class="btn btn-primary" role="button">加入购物车</a></p>
				  ...
				  <div class="col-sm-6 col-md-4">
				    <div class="thumbnail">
				      <img src="./resources/images/product-04.jpg" alt="产品">
				      <div class="caption">
				        <h3>产品1</h3>
				        <p>这个产品很不错，我很喜欢这个产品。真是太好了.....</p>
				        <p><a href="javascript:voud(0);" class="btn btn-primary" role="button">加入购物车</a></p>
...
<script type="text/javascript" src="./plugins/flycar/js/jquery.fly.min.js"></script>
<script type="text/javascript" src="./plugins/navcar/js/nav.js"></script>
